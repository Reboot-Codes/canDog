...
void spi_mem_scene_start_on_enter(void* context) {
    SPIMemApp* app = context;
    submenu_add_item(app->submenu, "Read", SPIMemSceneStartSubmenuIndexRead, spi_mem_scene_start_submenu_callback, app);
    submenu_add_item(app->submenu, "Saved", SPIMemSceneStartSubmenuIndexSaved, spi_mem_scene_start_submenu_callback, app);
    submenu_add_item(app->submenu, "Erase", SPIMemSceneStartSubmenuIndexErase, spi_mem_scene_start_submenu_callback, app);
    submenu_add_item(app->submenu, "Wiring", SPIMemSceneStartSubmenuIndexWiring, spi_mem_scene_start_submenu_callback, app);
    submenu_add_item(app->submenu, "About", SPIMemSceneStartSubmenuIndexAbout, spi_mem_scene_start_submenu_callback, app);
    submenu_set_selected_item(app->submenu, scene_manager_get_scene_state(app->scene_manager, SPIMemSceneStart));
