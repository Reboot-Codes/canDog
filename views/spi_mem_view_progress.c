...
void spi_mem_view_progress_set_read_callback(
    ...
    app->cb_ctx = cb_ctx;
    with_view_model(app->view, SPIMemProgressViewModel * model, { model->view_type = SPIMemProgressViewTypeRead; }, true);
}
...
void spi_mem_view_progress_set_verify_callback(
    ...
    app->callback = callback;
    app->cb_ctx = cb_ctx;
    with_view_model(app->view, SPIMemProgressViewModel * model, { model->view_type = SPIMemProgressViewTypeVerify; }, true);
}
...
void spi_mem_view_progress_set_write_callback(
    ...
    app->callback = callback;
    app->cb_ctx = cb_ctx;
    with_view_model(app->view, SPIMemProgressViewModel * model, { model->view_type = SPIMemProgressViewTypeWrite; }, true);
}
